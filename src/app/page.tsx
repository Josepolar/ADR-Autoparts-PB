          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-cyber-blue rounded-lg flex items-center justify-center">
                <span className="text-nardo-gray-900 font-bold text-lg">⚙</span>
              </div>
            ...
            <div className="flex gap-4">
              <Link
                href="/autoecu"
                className="px-4 py-2 text-text-secondary hover:text-cyber-blue transition-colors"
              >
                AutoECU
              </Link>
              <Link
              ...
              <Link
                href="/auth/signin"
                className="px-4 py-2 bg-cyber-blue text-nardo-gray-900 rounded-lg font-semibold hover:bg-cyber-blue-400 transition-colors"
              >
                Sign In
              </Link>
            </div>
